...
\caption{Illustration of the CBOW and Skip-Gram models, as presented by \citet{chen2017convolutional}}\label{figure:word2vecModels}
\end{figure}
\FloatBarrier
